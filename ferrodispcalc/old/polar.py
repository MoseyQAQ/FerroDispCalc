...
for i in ['0.3750','0.4375','0.5000']:
    a=Polar(f'traj {i}.lammpstrj',type_map=type_map,fmt='traj',natoms=2560,nframes=301)
    a.get_polar(prefix=f'{i}-',ele=['Ti','Zr'],r=3.5,O_num=6,vacancy=False)